...
min-height:4.3em;
box-shadow:0 1.3em 12px -3px rgb(0,0,0,4);
${tw`
flex
justify-center
items-center
...
export function Bookcard(){
    ...
    return <CardContainer>
        <ItemContainer>
            ...
            <SmallIcon><FontAwesomeIcon icon={isStartCalendarOpen ? faCaretUp: faCaretDown}/>
            </SmallIcon>
        ...
        <ItemContainer>
            ...
            <SmallIcon><FontAwesomeIcon icon = {isReturnCalendarOpen ? faCaretUp : faCaretDown} 
            />
            </SmallIcon>
            {isReturnCalendarOpen && < DateCalendar offset
